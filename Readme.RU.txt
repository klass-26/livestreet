...
5. Следовать инструкциям установщика. При создании базы данных обязательно поставить галку "Конвертировать базу 0.5.1 в 1.0.2"
...
2.1 Зайти по адресу http://ваш_сайт_на_ls/install/ и на шаге создания базы данных поставить галку "Конвертировать базу 1.0 в 1.0.2"
...
1. Перезаписать файлы из нового архива, каталог /templates/skin/ можно не перезаписывать
